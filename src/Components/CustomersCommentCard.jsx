...
export default function CustomersCommentCard({img1,img2, title, desc, name}) {
  return (
    <div className="flex flex-col m-auto md:flex-row gap-5 max-w-[800px] items-center justify-around rounded-2xl p-3 shadow-[rgba(0,0,0,0.24)_0px_3px_8px]">
      ...
      <div className="">
        <img className="rounded-2xl md:max-w-[390px] md:h-[400px] object-cover" src={img2} alt="" />
      </div>
    </div>
  );
}
